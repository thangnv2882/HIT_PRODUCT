...
public class PostController {
    ...
    @ApiOperation(value = "Đăng bài trên trang cá nhân.")
    ...
    public ResponseEntity<?> createPost(
            ...
            @RequestBody PostDTO postDTO) {
        return VsResponseUtil.ok(postService.createPostInGroup(idGroup, idUser, postDTO));
    }

    @ApiOperation(value = "Chỉnh sửa bài đăng (Chủ sở hữu có quyền chỉnh sửa).")
    ...
    public ResponseEntity<?> updatePost(
        ...
        return VsResponseUtil.ok(postService.updatePost(idUserFix, idPost, postDTO));
    }

    @ApiOperation(value = "Xoá bài đăng (Chủ sở hữu có quyền xóa).")
