...
public class UserController {
    ...
    public ResponseEntity<?> updateAvatarById(
            @PathVariable("id") Long id,
            @RequestParam(name = "linkAvt", required = false) String linkAvt){
        return VsResponseUtil.ok(userService.updateAvatarById(id, linkAvt));
    }
    ...
    public ResponseEntity<?> updateCoverById(
            @PathVariable("id") Long id,
            @RequestParam(name = "linkCover", required = false) String linkCover){
        return VsResponseUtil.ok(userService.updateCoverById(id, linkCover));
    }
    ...
    @ApiOperation(value = "Xem tất cả ảnh của người dùng.")
    ...
    @ApiOperation(value = "Xem tất cả video của người dùng.")
